...
class QLearningAgent(ReinforcementAgent):
    ...
    def computeActionFromQValues(self, state):
        ...
        """
        # Gets legal action fro current state
        legalActions = self.getLegalActions(state)
        if not legalActions:
            return None
        ...
        best_actions = []
        # Iterates Through all legal actions and updates the best value
    ...
    def update(self, state, action, nextState, reward):
        ...
        """
        "*** YOUR CODE HERE ***"
        # Compute the sample value for the update
    ...
    def getValue(self, state):
        # Return the value of a state, which is the maximum Q-value
